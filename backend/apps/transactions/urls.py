...
urlpatterns = [
    ...
    path('import/history/', views.ImportBatchListView.as_view(), name='import-batch-list'),
    path('import/<int:pk>/', views.ImportBatchDetailView.as_view(), name='import-batch-detail'),
