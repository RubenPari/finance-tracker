...
- **RF-40 (nuovo)** — **Analisi AI del profilo di spesa**: il sistema invia un riepilogo strutturato aggregato delle transazioni utente (ultimi 6 mesi, per categoria e trend mensili) a **Vercel AI Gateway** con modello `xai/grok-4.1-fast-non-reasoning`, ricevendo insight narrativi personalizzati.
...
- **RF-43 (nuovo)** — **Privacy e token limit**: i dati inviati a xai/grok-4.1-fast-non-reasoning non devono includere informazioni personali identificabili (PII) delle singole transazioni (merchant, ID transazione), ma solo aggregati per categoria e trend mensili.
